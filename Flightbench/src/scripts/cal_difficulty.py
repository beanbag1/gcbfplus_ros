...
class difficultyCalculator():
    def __init__(self, scene_path):
        # read pcd
        pcd_origin = o3d.io.read_point_cloud(os.path.join(scene_path, "env.pcd"))
...
if __name__ == "__main__":
    ...
    #     exit(-1)
    # else:
        #scene_path = os.path.join(os.environ["FLIGHTBENCH_PATH"],sys.argv[1])
        scene_path = os.path.join(os.environ["FLIGHTBENCH_PATH"],"scene/maze-high")
